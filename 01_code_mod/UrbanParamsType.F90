...
contains
  ...
  subroutine Init(this, bounds)
    ...
    !KO PLUMBER   use clm_varcon      , only : vkc
    !KO PLUMBER
    use clm_varcon      , only : vkc, rpi
    !KO PLUMBER
    ...
    do l = bounds%begl,bounds%endl
       ...
       if (lun%urbpoi(l)) then
          ...
          !KO PLUMBER         plan_ai = lun%canyon_hwr(l)/(lun%canyon_hwr(l) + 1._r8)
          !KO PLUMBER
          ...
          !KO PLUMBER         build_lw_ratio = plan_ai

          ! Calculate frontal area index
          !KO PLUMBER        frontal_ai = (1._r8 - plan_ai) * lun%canyon_hwr(l)

          ! Adjust frontal area index for different building configuration
          !KO PLUMBER          frontal_ai = frontal_ai * sqrt(1/build_lw_ratio) * sqrt(plan_ai)
